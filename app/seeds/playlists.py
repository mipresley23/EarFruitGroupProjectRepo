...
def seed_playlists():
    ...
    rockClassics = Playlist(
        name="Rock Classics", description='All the fundemental rock hits', cover_img_url='https://i.scdn.co/image/ab67706c0000bebb69ec8b5b03df1a6dfe45abf3', user_Id=1)
    tikTok = Playlist(
        name="TikTok Songs 2022", description='the biggest viral hits from TikTok', cover_img_url='https://i.scdn.co/image/ab67706c0000bebbec4b4b59e21d6190148b3247', user_Id=1)
    jesse = Playlist(
